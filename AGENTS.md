...
This project is indexed by GitNexus as **nixos-dotfiles** (149 symbols, 140 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
